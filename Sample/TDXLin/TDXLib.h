/*!
				...
				TDXLib‚Ì–{‘Ì@‚±‚ê‚ğ“Ç‚İ‚ß‚Î‚·‚×‚Ä‚Ìƒtƒ@ƒCƒ‹‚ğQÆ‚Å‚«‚é‚æ‚¤‚É‚·‚é
...
//•Ï”Œ^éŒ¾
typedef long			s64;	//longŒ^		8byte
typedef int				s32;	//intŒ^			4byte
typedef short			s16;	//shortŒ^		2byte
typedef char			s8;		//charŒ^		1byte
								
typedef unsigned long	u64;	//unsigned@longŒ^		8byte
typedef unsigned int	u32;	//unsigned@intŒ^		4byte
typedef unsigned short	u16;	//unsigned@shortŒ^		2byte
typedef unsigned char	u8;		//unsigned@charŒ^		1byte
								
typedef double			f64;	//doubleŒ^	8byte
typedef float			f32;	//floatŒ^	4byte
